...
uint8_t load1i(uint16_t adr);
uint8_t load1(uint16_t adr);
uint16_t load2i_nolog(uint16_t adr);
uint16_t load2i(uint16_t adr);
uint16_t load2(uint16_t adr);
uint32_t load4(uint16_t adr);
void store1(uint16_t adr, uint8_t data);
void store2(uint16_t adr, uint16_t data);
void store4(uint16_t adr, uint32_t data);
void SetCompare(int f);
void Reset(uint16_t sp, uint16_t pc);
void Execute(int n);
void regdiff(void);
void v1trap(void);
void v7trap(void);
